...
HD_PWD='/home/user/elettronica_base/labs/lab7/lab7.runs/lab7_block_design_dds_compiler_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab7_block_design_dds_compiler_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab7_block_design_dds_compiler_0_1.tcl
