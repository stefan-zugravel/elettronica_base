...
HD_PWD='C:/Users/stefa/Desktop/elettronica_base/labs/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterBCD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CounterBCD_wrapper.tcl
