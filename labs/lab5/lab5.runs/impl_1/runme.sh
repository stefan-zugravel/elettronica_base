...
HD_PWD='C:/Users/stefa/Desktop/elettronica_base/labs/lab5/lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CounterBCD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CounterBCD_wrapper.tcl -notrace
