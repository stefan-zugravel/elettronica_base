...
#
# Generated by export_simulation on Tue Jan 20 16:59:41 CET 2026
#
################################################################################
...
'-reset_run' switch to the './lab8_block_design.sh' script.

./lab8_block_design.sh -reset_run
...
./lab8_block_design.sh -noclean_files

For more information on the script, please type './lab8_block_design.sh -help'.
