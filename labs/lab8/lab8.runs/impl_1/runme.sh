...
HD_PWD='/home/user/elettronica_base/labs/lab8/lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab8_block_design_wrapper.tcl -notrace
