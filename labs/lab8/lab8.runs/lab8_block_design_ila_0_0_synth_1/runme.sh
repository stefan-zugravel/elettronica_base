...
HD_PWD='/home/user/elettronica_base/labs/lab8/lab8.runs/lab8_block_design_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_block_design_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab8_block_design_ila_0_0.tcl
