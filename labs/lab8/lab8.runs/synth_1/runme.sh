...
HD_PWD='/home/user/elettronica_base/labs/lab8/lab8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab8_block_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab8_block_design_wrapper.tcl
